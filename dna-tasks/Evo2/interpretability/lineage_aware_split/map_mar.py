"""MAP/MAR helpers for lineage-aware Evo2 interpretability.

Copied unchanged from ``Regression/interpretability/lineage_aware_split/map_mar.py``.
...
relevant set), so this module is reused as-is for Evo2.
"""
...
def mean_map_mar_rows(lineage_rows: pd.DataFrame) -> pd.DataFrame:
    """Average each random-split metric over eligible lineage-specific models."""
