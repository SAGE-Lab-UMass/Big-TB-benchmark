...
def train(args):
    ...
    print("Training...")
    train_with_acc_gradients(model, train_loader, val_loader, tokenizer, optimizer, scheduler, criterion, args)
    print("done!\n")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default="zhihan1996/DNABERT-S")
    parser.add_argument('--max_length', type=int, default=825, help="Max length of tokens")
    ...
    parser.add_argument('--output_dir', type=str, default="finetuned_dnabert_output")
    ...
    parser.add_argument('--embed_dir', type=str, default='/project/pi_annagreen_umass_edu/saishradha/project_data_curation/benchmarking/DNABERT_S/training_output/finetune/embeddings', help="Directory to save embeddings")
    ...
    parser.add_argument('--n_last_layers_to_unfreeze', type=int, default=2, help="Number of last layers to unfreeze for training")
