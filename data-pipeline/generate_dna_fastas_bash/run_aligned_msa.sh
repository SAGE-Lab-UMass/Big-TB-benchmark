...
group="group_1"
gene="rpoB"  # Example: you can change this value
...
# Check if start_end_sense is empty (gene not found)
...
python scripts/make_aligned_msa.py -f $input_vcf_paths -start $start -end $end -sense $sense -o results/$msa_type/$output_file -g $genbank_file_path --gene $gene --resistance-groups $group --f2 $secondary_vcf_paths
